...
{
    public class AutoObjectGraphTypeTestBase
    {
        ...
        public AutoObjectGraphTypeTestBase() : base()
        {
        ...
        protected IComplexGraphType Configure<TSource>() where TSource : new()
            => Configure(new TSource());

        protected IComplexGraphType Configure<TSource>(TSource value)
        {
            _source = value;
            _graphType = new AutoObjectGraphType<TSource>();
            return _graphType;
        }
